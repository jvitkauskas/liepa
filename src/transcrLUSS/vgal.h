...
struct VeiksmazodziuGalunes {
	char *Galune; char KamTipas; char Sangrazine;
...
struct PriesdeliuGrupes {
	char *Pavadinimas; char VisadKirc; char KircRaide;
	char Priegaide;
} PriesdGrup[VPriesdSk] = {
{"",0,0,0},
...
#else
extern struct VeiksmazodziuGalunes {
	char *Galune; char KamTipas; char Sangrazine;
	char Asmenuote; char KircRaide; char Priegaide;
	char KircTaisykle; char PriesdTE;
	char KalbDal; char Laikas; char NuosakaRusis;
...
extern struct PriesdeliuGrupes {
	char *Pavadinimas; char VisadKirc; char KircRaide;
	char Priegaide;
} PriesdGrup[252];
#endif
